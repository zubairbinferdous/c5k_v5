...
use App\Http\Controllers\Admin\BookFrontMatterController;
...
Route::middleware(['XSS'])->group(function () {
    ...
    // https://www.c5k.com/issue-1/article-19/10.63471-jitmbh24002-9
    // Route::get('/issue-{issueId}/article-{id}/10.63471-{article?}-{volumeId}', 'PageController@single_issue')->name('single.issue');
    // Route::get('/{issueId}/{id}/{volumeId}/{article?}', 'PageController@single_issue')->name('single.issue');
    // https://www.c5k.com/13/12/10/article/drsdr24004 
    Route::get('/{id}-{volumeId}-{issueId}-article/{article?}', 'PageController@single_issue')->name('single.issue');
...
Route::group(['prefix' => 'dashboard/admin', 'middleware' => ['auth', 'isAdmin', 'XSS']], function () {
    ...
    // Books Front Matter
    Route::resource('book-front-matter', BookFrontMatterController::class)->names('book.front-matter');

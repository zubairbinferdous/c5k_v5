...
@section('userContent')
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-wrap ml-3 pl-10">
                            <div class="w-full md:w-1/2 pt-5">
                                <h1 class="text-2xl md:text-3xl font-bold">Publish Dissertation/Thesis on Your Way.
                                </h1>
    ...
    <div class="flex justify-center items-center py-4">
        <a href="{{ route('thesis.index') }}"
            class="bg-blue-600 text-white py-2 px-4 shadow rounded hover:bg-blue-700 transition duration-200">
            All thesis
        </a>
    </div>
    ...
    <section class="w-full py-6 px-4 mx-auto max-w-7xl">
        <h3 class="text-2xl font-bold text-center text-gray-800">Find thesis by Category</h3>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 link-style">
            @foreach ($categories as $category)
                ...
                <a href="{{ route('thesis.category', $category->id) }}" class="">
                    <div
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition-all duration-300 text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2">Over the World Thesis Publishing Service
                    </h3>
                    <p class="text-gray-600 text-sm">With easy steps and expert advice, publish your work online. Benefit
                        from high-quality editing and personalized assistance tailored to your specific needs and
                        requirements. Achieve your creative goals with confidence.
                    </p>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition-all duration-300 text-center">
                    ...
                    <p class="text-gray-600 text-sm">Our publishing service ensures your thesis gets international
                        recognition. Reach a wider audience and maximize its impact with our comprehensive worldwide
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition-all duration-300 text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2">Publish Your Thesis with Expert Assistance
                    </h3>
                    <p class="text-gray-600 text-sm">Our committed group of experts provides comprehensive support
                        throughout the entire thesis publishing process. Trust us to help you achieve your academic goals
                        with confidence.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition-all duration-300 text-center">
                    ...
                    <p class="text-gray-600 text-sm">We publish your thesis using state-of-the-art print-on-demand
                        technology, minimizing waste and reducing our carbon footprint. Our service is cost-effective
                        and eco-friendly.</p>
                </div>
            </div>
        </div>
    ...
    <section class="container mx-auto py-12 px-4">
        <div class="text-center mb-10">
            <h2 class="text-3xl font-bold mb-2">Our Thesis Publishing Procedure is Easy and Quicker</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 shadow-md rounded-xl text-center">
                ...
                <h3 class="text-xl font-semibold mb-2">Submit your Thesis </h3>
                <p class="text-gray-600">Whether you have a complete manuscript or just a draft, we are eager to provide
                    constructive feedback within a few days—no obligations, no hassle.
                </p>
            </div>
            <div class="bg-white p-6 shadow-md rounded-xl text-center">
                ...
                <p class="text-gray-600">Every great work begins with refinement. In this phase of review and revision, we
                    elevate your ideas, ensuring they shine with clarity and precision.
                </p>
            </div>
            <div class="bg-white p-6 shadow-md rounded-xl text-center">
                <span class="text-3xl font-bold text-blue-600 mb-2 block">3</span>
                <h3 class="text-xl font-semibold mb-2">Proof of Thesis </h3>
                <p class="text-gray-600">Your thesis is evidence of your diligence and commitment. Let us help you perfect
                    it, ensuring that every argument is compelling and every detail is polished to perfection.
                </p>
            </div>
            <div class="bg-white p-6 shadow-md rounded-xl text-center">
                <span class="text-3xl font-bold text-blue-600 mb-2 block">4</span>
                <h3 class="text-xl font-semibold mb-2">Publish your Thesis </h3>
                <p class="text-gray-600">Transform your research into a published masterpiece! With us, your thesis will
                    reach readers around the globe and have a global influence.</p>
            </div>
        </div>
    ...
    <section class="bg-gray-100 py-12">
        <div class="container mx-auto px-4">
            <div class="text-center mb-10">
                <h3 class="text-2xl font-bold mb-2">Publish Your Dissertation/Thesis</h3>
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white p-6 rounded-xl shadow text-center">
                    ...
                    <h4 class="text-xl font-semibold mb-2">Publish Your Thesis</h4>
                ...
                <div class="bg-white p-6 rounded-xl shadow text-center">
                    ...
                    <h4 class="text-xl font-semibold mb-2">Share and Sell Your Thesis</h4>
    ...
    <section class="container mx-auto my-12 px-4">
        <h3 class="text-2xl font-bold text-center mb-8">Our Thesis Publishing Statistics</h3>
    ...
    <section class="container mx-auto my-12 px-4 flex flex-col lg:flex-row items-start gap-6">
        ...
        <div class="w-full lg:w-1/1">
            ...
            <p class="text-gray-700 mb-4">To provide authors and research scholars with a worldwide and extensive platform
                to showcase their unique work, C5KTP offers book or dissertation publication services. Publishing your book
                or dissertation as a book monograph can help you advance your understanding of the topic, influence your
                discipline, and start your academic career.
            </p>
            <p class="text-gray-700 mb-4">
                Each author whose book is published will have a permanent page on our website with their name, biographical
                information, and the ISBN and DOI number provided. Additionally, authors can make adjustments to their
                webpages post-publication.</p>

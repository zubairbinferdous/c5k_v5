...
<div class="container mx-auto px-4">
    <div class="news-details bg-white rounded-xl p-6 md:p-8 my-8 shadow">
        <img src="{{ asset('public/backend/news/' . $news->image) }}"
             alt="{{ $news->title }}"
             class="mx-auto rounded-xl max-w-full h-auto shadow-md hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105 w-full md:w-11/12">

        <h2 class="text-2xl md:text-3xl font-bold text-center text-gray-800 font-serif my-6">
            {{ $news->title }}
        </h2>

        <p class="text-[16px] mb-3 leading-relaxed text-justify text-black font-serif">
            {!! $news->details !!}
        </p>
    </div>
</div>

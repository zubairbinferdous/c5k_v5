...
<div class="container-fluid">
                ...
                <div class="col-lg-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">Create Book Front Matter</li>
                        </ol>
                      </nav>
                </div>
    ...
    <div class="row mb-3">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Create Front Matter</h4>

                <form method="POST" action="{{ URL::route('book.front-matter.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <select class="form-select" id="book_id" name="book_id">
                                <option selected disabled value="">Select Book List</option>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="front_matter" name="front_matter" placeholder="Please write here...">
                        </div>

                        <div class="col-lg-6 mb-3">
                            <label for="pages_range" class="form-label">Pages Range</label>
                            <input type="text" class="form-control" id="pages_range" name="pages_range" placeholder="Please write here...">
                        </div>
                    </div>
